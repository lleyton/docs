...
```
<Warning>you need SEMICOLONS! (`;`)</Warning>
...
# Guidelines
<Warning>
  Avoid using the <Tooltip tip="This includes gh() and gh_tag()">GitHub API</Tooltip> for fetching the latest versions.
...
<Warning>Avoid running code unrelated to updating/bumping packages.</Warning>
